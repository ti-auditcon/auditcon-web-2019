...
@section('title')
  <title>Contacto | Auditcon - Rioseco Auditores</title>
      ...
      <div class="experience container">
        ...
        <div class="row text-center pd-tb-4 px-md-5">
          <div class="col-lg col-xl-9 mx-auto">
            ...
            <h1 class="mb-0 pb-0 pb-md-3 w-700 color-white">Una pequeña acción<br>El comienzo de <span class="color-goldenSand">un futuro mejor</span></h1>
    ...
    <section class="contactForm-wrapper container-fluid background-bunker color-white pb-md-4">
      <div class="contactForm container">
        <div class="row pd-tb-2">
          <div class="col-12">
            <h1 class="w-700 text-center color-goldenSand">Formulario de Contacto</h1>
          </div>
          <div class="contactForm-form col-12">
            ...
            {{-- <form class="row" method="POST" action="/captcha" id="captcha-form"> --}}
              ...
              <div class="col-12">
                ...
                <textarea class="textarea-message form-control background-transparent" id="textareaMessage" rows="6" placeholder="Su mensaje aquí" name="message"></textarea>
                <br>
